...
/**
    * Submitted for verification at BscScan.com on 2021-09-06
    ...
    #Dota Finance features:
        - 5% fee auto add to the liquidity pool to locked forever when selling
        - 5% fee auto distribute to all holders
        - I created a black hole so #Dota Finance token will deflate itself in supply with every transaction
...
contract DotaFinanceToken is Context, IERC20, Ownable {
    ...
    string private _name = "Dota Finance Token";
